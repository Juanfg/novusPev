    ...
    <section>
        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
                ...
                <tr>
                    <td><a href="{{ route('directores.show', [ $director->id]) }}"><img src="{{Storage::url($director->foto)}}" heigth="80" width="80" class="img-thumbnail"></td>
                    <td>{{ $director->nombre . " " . $director->apellido }}</td>
                    <td>{{ $director->campus->nombre }}</td>
                    <td>{{ $director->email_itesm }}</td>
                    <td>{{ $director->email_personal }}</td>
                    <td width="10%">
                        <div class="col-md-1">
