...
class PeriodoController extends Controller
{
    ...
    {
        return view('periodos.index', ['periodos' => Periodo::all()]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $alreadyExists = Periodo::where('periodo',$request->periodo)->count();

        if($alreadyExists == 0){
            //no existe
            Periodo::create(["periodo"=>$request->periodo]);
        }else{
            //existe
            $request->session()->flash('error', "Este periodo ya ha sido registrado");
